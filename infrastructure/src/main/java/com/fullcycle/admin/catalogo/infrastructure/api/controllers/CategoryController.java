...
public class CategoryController implements CategoryAPI {
    ...
    public CategoryController(final CreateCategoryUseCase createCategoryUseCase, final GetCategoryByIdUseCase getCategoryByIdUseCase,
                              final UpdateCategoryUseCase updateCategoryUseCase, final DeleteCategoryUseCase deleteCategoryUseCase,
    ...
    public ResponseEntity<?> createCategory(final CreateCategoryRequest input) {
        ...
        final Function<CreateCategoryOutput, ResponseEntity<?>> onSuccess = createCategoryOutput ->
                ResponseEntity.created(URI.create("/categories/"+createCategoryOutput.id())).body(createCategoryOutput);
